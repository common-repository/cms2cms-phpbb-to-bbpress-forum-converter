...
class CmsPluginFunctionsphpBB
{
    ...
    private $jsConfig = '{
        ...
        "wp_feedback"     : "//wordpress.org/support/plugin/cms2cms-phpbb-to-bbpress-forum-converter/reviews",
        "public_host"     : "//www.cms2cms.com",
        "bridge"          : "https://app.cms2cms.com/bridge/download",
        "phpBBExtension" : "https://cms2cms.com/files/joomla/cms2cmsconnector/com_cms2cmsconnector.zip",
    ...
    {
        $cms2cms_phpBB_access_login = get_option('cms2cms-phpBB-login');
        $cms2cms_phpBB_access_key   = get_option('cms2cms-phpBB-key');

        return array(
            'email'     => $cms2cms_phpBB_access_login,
            'accessKey' => $cms2cms_phpBB_access_key
        );
    }
    ...
    public function isActivated()
    {
        ...
        return ($cms2cms_phpBB_access_key != false);
    }
    ...
    public function getOptions()
    {
        ...
        $login = get_option('cms2cms-phpBB-login');
    ...
    public function saveOptions()
    {
        ...
        if ( $key && $login ) {
            ...
            add_option('cms2cms-phpBB-key', $key);

            delete_option('cms2cms-phpBB-login');
            add_option('cms2cms-phpBB-login', $login);

            delete_option('cms2cms-phpBB-depth');
            add_option('cms2cms-phpBB-depth', $bridge_depth);
    ...
    {
        return $this->__('phpBB', 'cms2cms-phpBB-migration');
    }
    ...
    {
        return $this->__('bbPress', 'cms2cms-phpBB-migration');
    }
    ...
    {
        return sprintf(
            $this->__('CMS2CMS: Automated %s to %s Migration ', 'cms2cms-phpBB-migration'),
    ...
    {
        return sprintf(
            $this->__('%s to %s', 'cms2cms-phpBB-migration'),
            $this->getPluginSourceName(),
            $this->getPluginTargetName()
        );
    }
    ...
    public function logOut()
    {
        if (isset($_REQUEST['_wpnonce'])) {
            ...
            if ($this->verifyFormTempKey($nonce, 'cms2cms_phpBB_logout')
                && $_POST['cms2cms_phpBB_logout'] == 1
            ) {
                $this->clearOptions();
            }
        }
